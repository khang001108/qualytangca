    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Nút chọn ca */}
                <div
                    className={`flex justify-center gap-3 mb-4 transition ${loading ? "opacity-50 pointer-events-none" : ""
                        }`}
                >
                    <button
                ...
                {/* Lưới ngày */}
                <div
                    className={`grid grid-cols-7 gap-2 mb-4 transition ${loading ? "opacity-50 pointer-events-none" : ""
                        }`}
                >
