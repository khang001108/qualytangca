...
export default function AddMemberForm({
  ...
  const handleOverlayClick = (e) => {
    ...
    // Nếu popup con đang mở => kiểm tra xem click có nằm trong popup con không
    ...
    // Nếu không nằm trong modal cha hoặc popup con => đóng cha
    setShowAdd(false);
  };
